//Table table = loadTable("2017820131116.csv");
...
void setup() {
  ...
  // collect all file names in the data folder
  ...
  for (int i=0; i<tables.size(); i++) {
    ...
    TableRow newRow = resultsTable.addRow(); // create new row for each experiment in the results table
    newRow.setInt("ID", i);
